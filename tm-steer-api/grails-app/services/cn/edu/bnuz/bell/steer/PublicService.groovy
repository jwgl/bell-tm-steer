...
''', [userId: userId]
    ...
    def getFormForShow(String userId, Long id) {
        ...
        if (form) {
            ...
            def schedule = [
                    evaluationSystem: observationCriteriaService.getObservationCriteriaByIdAndMethod(form.observationCriteria.id, observationFormService.realMethod(form.method)),
