...
''', [dept: dept, types: types, termId: termId ]
    ...
    def getFormForShow(Long id) {
        ...
        if (form) {
            ...
            def evaluationSystem = observationCriteriaService.getObservationCriteriaByIdAndMethod(form.observationCriteria?.id, observationFormService.realMethod(form.method))
